...
export class NewOfferPage implements OnInit {
  ...
  ngOnInit() {
    this.form = new FormGroup({
      ...
      dateFrom: new FormControl(new Date().toISOString(), {updateOn: 'blur', validators: [Validators.required]}),
      dateTo: new FormControl(new Date().toISOString(), {updateOn: 'blur', validators: [Validators.required]}),
    });
  }
